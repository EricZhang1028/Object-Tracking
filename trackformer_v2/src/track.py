...
def main(seed, dataset_name, obj_detect_checkpoint_file, tracker_cfg,
    ...
    for seq in dataset:
        ...
        print(f"start_frame = {start_frame}, end_frame = {end_frame}, seq = {seq}, len_seq = {len(seq)}")
        ...
        if not results:
            ...
            np.savez(os.path.join(output_dir, "results.npz"), results=results) # saved results as .npz file
